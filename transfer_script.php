...
$session_id = db_insert_query("INSERT INTO Session (date) VALUES (CURRENT_TIMESTAMP)");
echo "Why? $session_id\n";
...
$prof_id = "3";
db_query("INSERT INTO Records (session_id, profile_id) VALUES ('$session_id', '$prof_id')");
